...
def single_run(dkey, train_size, lamcrit, param, seed, profile=False):
    ...
    print("Processing data set %s with train_size %s, lamcrit %s, seed %s, and parameters %s ..." % (str(dkey), str(train_size), str(lamcrit), str(seed), str(param)))
    ...
    fname = os.path.join(params.odir, str(dkey), str(train_size), str(lamcrit), "hugewood", fname)
...
single_run(dkey, train_size, lamcrit, params.parameters_hugewood[key], seed)
